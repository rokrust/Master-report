...
%Acquisition and tracking. Matching of prn codes
\subsubsection{Doppler shift}
\missingfigure[]{Doppler shift}
% Satellite has high speed. Doppler effect
% Acquisition requires known doppler, or search through frequency
% Doppler equation



\subsubsection{Carrier Phase} \todo{Proper title}
...
\subsection{Error sources} \todo{proper title}
...
Without the constant frequency correction applied, the difference in observed frequencies would accumulate to a clock error of approximately $38 \mu s$ a day, leading to a navigation error of approximately 11 km, \cite{pascual2007introducing}\todo{check article and add to source or find new source}.
